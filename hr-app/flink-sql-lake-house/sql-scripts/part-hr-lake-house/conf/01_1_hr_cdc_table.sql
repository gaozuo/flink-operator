...
CREATE TABLE `CDC_WAF_CORE_ENTITY`
(
...
CREATE TABLE `CDC_BORG_JGXX_BASEINFO`
(
    `TS`                       TIMESTAMP(3) METADATA FROM 'timestamp',
...
CREATE TABLE `CDC_HR_EMP_BASICINFO`
(
    `TS`                        TIMESTAMP(3) METADATA FROM 'timestamp',
...
CREATE TABLE `CDC_WAF_CORE_DICTITEM`
(
    `TS`                        TIMESTAMP(3) METADATA FROM 'timestamp',
...
CREATE TABLE `CDC_WAF_AC_ORGAN2BIZ`
(
    `TS`         TIMESTAMP(3) METADATA FROM 'timestamp',
...
CREATE TABLE `CDC_HR_DICTV2_DICTIONARY`
(
    `TS`                        TIMESTAMP(3) METADATA FROM 'timestamp',
...
CREATE TABLE `CDC_MV_HR_DICTV2_RULE`
(
    `TS`                        TIMESTAMP(3) METADATA FROM 'timestamp',
    `DICT_CODE`     VARCHAR(2147483647) NOT NULL,
    `TYPE`          VARCHAR(2147483647),
...
CREATE TABLE `CDC_WAF_CORE_DICT`
(
    `TS`            TIMESTAMP(3) METADATA FROM 'timestamp',
...
CREATE TABLE `CDC_HR_MOVE_INSIDER`
(
    `TS`               TIMESTAMP(3) METADATA FROM 'timestamp',
...
CREATE TABLE `CDC_HR_MOVE_ENTRYAPPLY`
(
    `TS`             TIMESTAMP(3) METADATA FROM 'timestamp',
...
CREATE TABLE `CDC_HR_WORK_LABCONTRACT`
(
    `TS`                TIMESTAMP(3) METADATA FROM 'timestamp',
...
CREATE TABLE `CDC_HR_EMP_SOCIALRELATIONINFO`
(
    `TS`                   TIMESTAMP(3) METADATA FROM 'timestamp',
...
CREATE TABLE `CDC_HR_EMP_VALIDPASSPORT`
(
    `TS`                 TIMESTAMP(3) METADATA FROM 'timestamp',
...
CREATE TABLE `CDC_HR_EMP_PROFRESULTPATENTINFO`
(
    `TS`               TIMESTAMP(3) METADATA FROM 'timestamp',
...
CREATE TABLE `CDC_HR_EMP_MAINTHESISWORKINFO`
(
    `TS`                TIMESTAMP(3) METADATA FROM 'timestamp',
...
CREATE TABLE `CDC_HR_EMP_TRAININFO`
(
    `TS`              TIMESTAMP(3) METADATA FROM 'timestamp',
...
CREATE TABLE `CDC_HR_EMP_REWARDINFO`
(
    `TS`             TIMESTAMP(3) METADATA FROM 'timestamp',
...
CREATE TABLE `CDC_HR_EMP_PROJPREFINFO`
(
    `TS`                TIMESTAMP(3) METADATA FROM 'timestamp',
...
CREATE TABLE `CDC_HR_WORK_CHECKRESULT`
(
    `TS`           TIMESTAMP(3) METADATA FROM 'timestamp',
...
CREATE TABLE `CDC_HR_EMP_TECHPROGRADE`
(
    `TS`            TIMESTAMP(3) METADATA FROM 'timestamp',
...
CREATE TABLE `CDC_HR_EMP_SEAMANCERTINFO`
(
    `TS`                   TIMESTAMP(3) METADATA FROM 'timestamp',
    `PENALTYID`            VARCHAR(2147483647) NOT NULL,
    `EMPID`                VARCHAR(2147483647),
...
CREATE TABLE `CDC_HR_EMP_QUACERTINFO`
(
    `TS`               TIMESTAMP(3) METADATA FROM 'timestamp',
...
CREATE TABLE `CDC_HR_EMP_EXPERTINFO`
(
    `TS`           TIMESTAMP(3) METADATA FROM 'timestamp',
    `PENALTYID`    VARCHAR(2147483647) NOT NULL,
    `EMPID`        VARCHAR(2147483647),
...
CREATE TABLE `CDC_HR_EMP_PROFTECHPOSITIONQUA`
(
    `TS`               TIMESTAMP(3) METADATA FROM 'timestamp',
...
CREATE TABLE `CDC_HR_EMP_ACADEMICDEGREECERT`
(
    `TS`                TIMESTAMP(3) METADATA FROM 'timestamp',
...
CREATE TABLE `CDC_HR_WORK_EMPPOSITION`
(
    `TS`                TIMESTAMP(3) METADATA FROM 'timestamp',
...
CREATE TABLE `CDC_HR_WORK_POSTWORKINFO`
(
    `TS`                       TIMESTAMP(3) METADATA FROM 'timestamp',
...
CREATE TABLE `CDC_WAF_APP_ATTACH`
(
    `TS`         TIMESTAMP(3) METADATA FROM 'timestamp',
...
CREATE TABLE `CDC_WAF_APP_ATTACHREF`
(
    `TS`       TIMESTAMP(3) METADATA FROM 'timestamp',
...
CREATE TABLE `CDC_WAF_CORE_ENTITYITEM`
(
    `TS`               TIMESTAMP(3) METADATA FROM 'timestamp',
...
CREATE TABLE `CDC_BORG_JGXX_CERTIFICATE`
(
    `TS`                TIMESTAMP(3) METADATA FROM 'timestamp',
    `ID`                VARCHAR(2147483647) NOT NULL,
    `BORGID`            VARCHAR(2147483647),
...
CREATE TABLE `CDC_BORG_JGXX_DOT`
(
    `TS`             TIMESTAMP(3) METADATA FROM 'timestamp',
    `ID`             VARCHAR(2147483647) NOT NULL,
    `BORGID`         VARCHAR(2147483647),
...
CREATE TABLE `CDC_BORG_JGXX_PATENT`
(
    `TS`           TIMESTAMP(3) METADATA FROM 'timestamp',
    `ID`           VARCHAR(2147483647) NOT NULL,
    `BORGID`       VARCHAR(2147483647),
...
CREATE TABLE `CDC_BORG_JGXX_QUALIFICATION`
(
    `TS`            TIMESTAMP(3) METADATA FROM 'timestamp',
    `ID`            VARCHAR(2147483647) NOT NULL,
    `BORGID`        VARCHAR(2147483647),
...
CREATE TABLE `CDC_BORG_JGXX_SHAREHOLDER`
(
    `TS`                 TIMESTAMP(3) METADATA FROM 'timestamp',
    `ID`                 VARCHAR(2147483647) NOT NULL,
    `BORGID`             VARCHAR(2147483647),
...
CREATE TABLE `CDC_HR_TV2_TAG_INS`
(
    `TS`                 TIMESTAMP(3) METADATA FROM 'timestamp',
...
CREATE TABLE `CDC_HR_TV2_EMP_TAG_INS`
(
    `TS`                 TIMESTAMP(3) METADATA FROM 'timestamp',
...
CREATE TABLE `CDC_TECHNOLOGY_HJQK`
(
    `ID`                 VARCHAR(2147483647) NOT NULL,
...
CREATE TABLE `CDC_TECHNOLOGY_ZL`
(
    `ID`                 VARCHAR(2147483647) NOT NULL,
...
CREATE TABLE `CDC_TECHNOLOGY_BZGF`
(
    `ID`                 VARCHAR(2147483647) NOT NULL,
...
CREATE TABLE `CDC_TECHNOLOGY_ZZ`
(
    `ID`                 VARCHAR(2147483647) NOT NULL,
...
CREATE TABLE `CDC_TECHNOLOGY_GJKJJHXM`
(
    `ID`                 VARCHAR(2147483647) NOT NULL,
    `RYBM`               VARCHAR(2147483647),
...
CREATE TABLE `CDC_TECHNOLOGY_ZJJTXMK`
(
    `ID`                 VARCHAR(2147483647) NOT NULL,
    `RYBM`               VARCHAR(2147483647),
    `WCSJ`               VARCHAR(2147483647),
...
CREATE TABLE `CDC_TECHNOLOGY_SBJKT`
(
    `ID`                 VARCHAR(2147483647) NOT NULL,
    `RYBM`               VARCHAR(2147483647),
    `WCSJ`               VARCHAR(2147483647),
...
CREATE TABLE `CDC_TECHNOLOGY_HEKTJBXX`
(
	`ID`                 VARCHAR(2147483647) NOT NULL,
	`RYBM`               VARCHAR(2147483647),
    `WCSJ`               VARCHAR(2147483647),
...
CREATE TABLE `CDC_TECHNOLOGY_ZZLXKT`
(
    `ID`                 VARCHAR(2147483647) NOT NULL, 
    `RYBM`               VARCHAR(2147483647),
    `WCSJ`               VARCHAR(2147483647),
