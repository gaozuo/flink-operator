...
WITH (
    'connector' = 'hudi',
    'path' = 's3a://hr-oss-bucket01/hudi_lake_raw_waf_core_entity',
...
WITH (
    'connector' = 'hudi',
    'path' = 's3a://hr-oss-bucket01/hudi_lake_raw_waf_core_entityitem',
    'table.type' = 'MERGE_ON_READ',
    'read.streaming.enabled' = 'true', -- this option enable the streaming read
    'read.streaming.check-interval' = '4' -- specifies the check interval for finding new source commits, default 60s.
);
...
WITH (
    'connector' = 'hudi',
    'path' = 's3a://hr-oss-bucket01/hudi_lake_raw_waf_app_attach',
    'table.type' = 'MERGE_ON_READ',
    'read.streaming.enabled' = 'true', -- this option enable the streaming read
    'read.streaming.check-interval' = '4' -- specifies the check interval for finding new source commits, default 60s.
);
...
WITH (
    'connector' = 'hudi',
    'path' = 's3a://hr-oss-bucket01/hudi_lake_raw_waf_app_attachref',
    'table.type' = 'MERGE_ON_READ',
    'read.streaming.enabled' = 'true', -- this option enable the streaming read
    'read.streaming.check-interval' = '4' -- specifies the check interval for finding new source commits, default 60s.
);
...
WITH (
    'connector' = 'hudi',
    'path' = 's3a://hr-oss-bucket01/hudi_lake_raw_hr_emp_basicinfo',
    'table.type' = 'MERGE_ON_READ',
    'read.streaming.enabled' = 'true', -- this option enable the streaming read
    'read.streaming.check-interval' = '4' -- specifies the check interval for finding new source commits, default 60s.
);
...
WITH (
    'connector' = 'hudi',
    'path' = 's3a://hr-oss-bucket01/hudi_lake_raw_hr_work_postworkinfo',
    'table.type' = 'MERGE_ON_READ',
    'read.streaming.enabled' = 'true', -- this option enable the streaming read
    'read.streaming.check-interval' = '4' -- specifies the check interval for finding new source commits, default 60s.
);
...
WITH (
    'connector' = 'hudi',
    'path' = 's3a://hr-oss-bucket01/hudi_lake_raw_hr_work_empposition',
    'table.type' = 'MERGE_ON_READ',
    'read.streaming.enabled' = 'true', -- this option enable the streaming read
    'read.streaming.check-interval' = '4' -- specifies the check interval for finding new source commits, default 60s.
);
...
WITH (
    'connector' = 'hudi',
    'path' = 's3a://hr-oss-bucket01/hudi_lake_raw_hr_emp_academicdegreecert',
    'table.type' = 'MERGE_ON_READ',
    'read.streaming.enabled' = 'true', -- this option enable the streaming read
    'read.streaming.check-interval' = '4' -- specifies the check interval for finding new source commits, default 60s.
);
...
WITH (
    'connector' = 'hudi',
    'path' = 's3a://hr-oss-bucket01/hudi_lake_raw_hr_emp_proftechpositionqua',
    'table.type' = 'MERGE_ON_READ',
    'read.streaming.enabled' = 'true', -- this option enable the streaming read
    'read.streaming.check-interval' = '4' -- specifies the check interval for finding new source commits, default 60s.
);
...
WITH (
    'connector' = 'hudi',
    'path' = 's3a://hr-oss-bucket01/hudi_lake_raw_waf_ac_organ',
    'table.type' = 'MERGE_ON_READ',
    'read.streaming.enabled' = 'true', -- this option enable the streaming read
    'read.streaming.check-interval' = '4' -- specifies the check interval for finding new source commits, default 60s.
);
...
WITH (
    'connector' = 'hudi',
    'path' = 's3a://hr-oss-bucket01/hudi_lake_raw_waf_ac_organ2biz',
    'table.type' = 'MERGE_ON_READ',
    'read.streaming.enabled' = 'true', -- this option enable the streaming read
    'read.streaming.check-interval' = '4' -- specifies the check interval for finding new source commits, default 60s.
);
...
WITH (
    'connector' = 'hudi',
    'path' = 's3a://hr-oss-bucket01/hudi_lake_raw_mv_hr_dictv2_rule',
    'table.type' = 'MERGE_ON_READ',
    'read.streaming.enabled' = 'true', -- this option enable the streaming read
    'read.streaming.check-interval' = '4' -- specifies the check interval for finding new source commits, default 60s.
);
...
WITH (
    'connector' = 'hudi',
    'path' = 's3a://hr-oss-bucket01/hudi_lake_raw_waf_core_dict',
    'table.type' = 'MERGE_ON_READ',
    'read.streaming.enabled' = 'true', -- this option enable the streaming read
    'read.streaming.check-interval' = '4' -- specifies the check interval for finding new source commits, default 60s.
);
...
WITH (
    'connector' = 'hudi',
    'path' = 's3a://hr-oss-bucket01/hudi_lake_raw_waf_core_dictitem',
    'table.type' = 'MERGE_ON_READ',
    'read.streaming.enabled' = 'true', -- this option enable the streaming read
    'read.streaming.check-interval' = '4' -- specifies the check interval for finding new source commits, default 60s.
);
...
WITH (
    'connector' = 'hudi',
    'path' = 's3a://hr-oss-bucket01/hudi_lake_raw_hr_tv2_tag_ins',
    'table.type' = 'MERGE_ON_READ',
    'read.streaming.enabled' = 'true', -- this option enable the streaming read
    'read.streaming.check-interval' = '4' -- specifies the check interval for finding new source commits, default 60s.
);
...
WITH (
    'connector' = 'hudi',
    'path' = 's3a://hr-oss-bucket01/hudi_lake_raw_hr_tv2_emp_tag_ins',
    'table.type' = 'MERGE_ON_READ',
    'read.streaming.enabled' = 'true', -- this option enable the streaming read
    'read.streaming.check-interval' = '4' -- specifies the check interval for finding new source commits, default 60s.
);
...
WITH (
    'connector' = 'hudi',
    'path' = 's3a://hr-oss-bucket01/hudi_lake_raw_project_manager_performance',
    'table.type' = 'MERGE_ON_READ',
    'read.streaming.enabled' = 'true', -- this option enable the streaming read
    'read.streaming.check-interval' = '4' -- specifies the check interval for finding new source commits, default 60s.
);