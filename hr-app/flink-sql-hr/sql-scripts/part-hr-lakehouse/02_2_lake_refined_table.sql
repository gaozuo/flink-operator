...
WITH (
    'connector' = 'hudi',
    'path' = 's3a://hr-oss-bucket01/hudi/lake_refined_operation_entity',
...
WITH (
    'connector' = 'hudi',
    'path' = 's3a://hr-oss-bucket01/hudi/lake_refined_config_entity_type',
    'table.type' = 'MERGE_ON_READ',
    'read.streaming.enabled' = 'true', -- this option enable the streaming read
    'read.streaming.check-interval' = '4' -- specifies the check interval for finding new source commits, default 60s.
);
...
WITH (
    'connector' = 'hudi',
    'path' = 's3a://hr-oss-bucket01/hudi/lake_refined_config_entity_duty_type',
    'table.type' = 'MERGE_ON_READ',
    'read.streaming.enabled' = 'true', -- this option enable the streaming read
    'read.streaming.check-interval' = '4' -- specifies the check interval for finding new source commits, default 60s.
);
...
WITH (
    'connector' = 'hudi',
    'path' = 's3a://hr-oss-bucket01/hudi/lake_refined_operation_entity_duty',
    'table.type' = 'MERGE_ON_READ',
    'read.streaming.enabled' = 'true', -- this option enable the streaming read
    'read.streaming.check-interval' = '4' -- specifies the check interval for finding new source commits, default 60s.
);
...
WITH (
    'connector' = 'hudi',
    'path' = 's3a://hr-oss-bucket01/hudi/lake_refined_entity',
    'table.type' = 'MERGE_ON_READ',
    'read.streaming.enabled' = 'true', -- this option enable the streaming read
    'read.streaming.check-interval' = '4' -- specifies the check interval for finding new source commits, default 60s.
);
...
WITH (
    'connector' = 'hudi',
    'path' = 's3a://hr-oss-bucket01/hudi/lake_refined_entity_relation',
    'table.type' = 'MERGE_ON_READ',
    'read.streaming.enabled' = 'true', -- this option enable the streaming read
    'read.streaming.check-interval' = '4' -- specifies the check interval for finding new source commits, default 60s.
);
...
WITH (
    'connector' = 'hudi',
    'path' = 's3a://hr-oss-bucket01/hudi/lake_refined_entity_property',
    'table.type' = 'MERGE_ON_READ',
    'read.streaming.enabled' = 'true', -- this option enable the streaming read
    'read.streaming.check-interval' = '4' -- specifies the check interval for finding new source commits, default 60s.
);
...
WITH (
    'connector' = 'hudi',
    'path' = 's3a://hr-oss-bucket01/hudi/lake_refined_entity_permission',
    'table.type' = 'MERGE_ON_READ',
    'read.streaming.enabled' = 'true', -- this option enable the streaming read
    'read.streaming.check-interval' = '4' -- specifies the check interval for finding new source commits, default 60s.
);
